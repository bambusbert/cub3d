...
/*   Updated: 2026/07/16 15:38:52 by slambert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_texture_e(t_god *p_god)
{
	...
	p_god->sprite_wall_E->img_addr = mlx_get_data_addr(p_god->sprite_wall_E->img,
			&p_god->sprite_wall_E->img_bits_per_pixel,
			&p_god->sprite_wall_E->img_line_length,
			&p_god->sprite_wall_E->img_endian);
}
...
void	init_texture_w(t_god *p_god)
{
	...
	if (!p_god->sprite_wall_W->img)
		error_exit("Error\nerror in init_texture\n", p_god);
	p_god->sprite_wall_W->img_addr = mlx_get_data_addr(p_god->sprite_wall_W->img,
			&p_god->sprite_wall_W->img_bits_per_pixel,
			&p_god->sprite_wall_W->img_line_length,
			&p_god->sprite_wall_W->img_endian);
}
...
void	init_texture_s(t_god *p_god)
{
	...
	if (!p_god->sprite_wall_S->img)
		error_exit("Error\nerror in init_texture\n", p_god);
	p_god->sprite_wall_S->img_addr = mlx_get_data_addr(p_god->sprite_wall_S->img,
			&p_god->sprite_wall_S->img_bits_per_pixel,
			&p_god->sprite_wall_S->img_line_length,
			&p_god->sprite_wall_S->img_endian);
}
...
void	init_texture_n(t_god *p_god)
{
	...
	if (!p_god->sprite_wall_N->img)
		error_exit("Error\nerror in init_texture\n", p_god);
	p_god->sprite_wall_N->img_addr = mlx_get_data_addr(p_god->sprite_wall_N->img,
			&p_god->sprite_wall_N->img_bits_per_pixel,
			&p_god->sprite_wall_N->img_line_length,
			&p_god->sprite_wall_N->img_endian);
}
